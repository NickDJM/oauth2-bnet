...
## Any contribution you make will be under the MIT License

In short, when you submit code changes, your submissions are understood to be under the same MIT License that covers the project. Feel free to contact the maintainers if that's a concern.

## Report bugs using Github's [issues](https://github.com/NickDJM/oauth2-bnet/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/NickDJM/oauth2-bnet/issues/new).
...
- Run `composer install` to ensure you have all the tools needed.
- Keep all functional code inside of the `src/` directory.
- Keep all test code inside of the `test/` directory.
- Use the coding standards provided.

This project follows the [PSR-2](https://www.php-fig.org/psr/psr-2/) coding standards.

To check your code, you can use [PHP_CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer/) with the provided script:
